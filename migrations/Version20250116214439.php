 ...
 */
final class Version20250116214439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("ALTER TABLE utilisateur ADD roles JSON NOT NULL DEFAULT '[]'");
        $this->addSql('ALTER TABLE utilisateur DROP role');
        $this->addSql('ALTER TABLE utilisateur ALTER mdp_chiffre TYPE VARCHAR(255)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ALTER mdp_chiffre TYPE TEXT');
    }
}
