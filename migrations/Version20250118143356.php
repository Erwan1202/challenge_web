 ...
 */
final class Version20250118143356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte_bancaire ALTER numero_de_compte TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE compte_bancaire ALTER decouvert_autorise DROP NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_50BC21DE993776DB ON compte_bancaire (numero_de_compte)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_50BC21DE993776DB');
        $this->addSql('ALTER TABLE compte_bancaire ALTER numero_de_compte TYPE INT');
        $this->addSql('ALTER TABLE compte_bancaire ALTER decouvert_autorise SET NOT NULL');
